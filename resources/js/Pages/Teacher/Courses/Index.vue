                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full"
                                            :class="{
                                                ...
                                                'bg-gray-100 text-gray-800': !['published','draft','archived'].includes(course.status)
                                            }">
                                            {{ course.status === 'published' ? 'فعال' :
                                               course.status === 'draft' ? 'پیش‌نویس' :
                                               course.status === 'archived' ? 'آرشیو شده' : course.status }}
                                        </span>
                                    </td>
